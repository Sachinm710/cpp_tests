...
##
## Debug
ProjectName            :=UdemyCplusplus
ConfigurationName      :=Debug
WorkspacePath          :=S:/Studies/UdemyCplusplus/UdemyCplusplus
ProjectPath            :=S:/Studies/UdemyCplusplus/UdemyCplusplus/UdemyCplusplus
...
ObjectsFileList        :="UdemyCplusplus.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/test.cpp$(ObjectSuffix): test.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "S:/Studies/UdemyCplusplus/UdemyCplusplus/UdemyCplusplus/test.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test.cpp$(ObjectSuffix) $(IncludePath)
